      ...
      '<main>',
        ...
        '<section class="ts100-wisdom-search ts100-frame" id="ts100WisdomSearchSection" aria-label="오늘의 지혜 찾기">',
          '<div class="ts100-section-head">',
            ...
            '<p class="ts100-section-desc">상황, 사자성어, 삶의 영역 중 편한 방법으로 찾아보세요.</p>',
          '</div>',
          '<div class="ts100-wisdom-mode-tabs" role="tablist" aria-label="지혜 찾기 방식">',
            '<button type="button" class="ts100-wisdom-mode-tab is-active" data-action="wisdom-mode-situation" data-wisdom-mode="situation" role="tab" aria-selected="true">상황별</button>',
            '<button type="button" class="ts100-wisdom-mode-tab" data-action="wisdom-mode-idiom" data-wisdom-mode="idiom" role="tab" aria-selected="false">사자성어</button>',
            '<button type="button" class="ts100-wisdom-mode-tab" data-action="wisdom-mode-life" data-wisdom-mode="life" role="tab" aria-selected="false">삶의 영역</button>',
          '</div>',

          '<div class="ts100-wisdom-mode-panel" data-bind="wisdom-panel-situation" role="tabpanel">',
            '<div class="ts100-wisdom-search-box">',
              '<input type="text" class="ts100-wisdom-search-input" data-bind="wisdom-search-input" placeholder="지금 마음에 걸리는 일을 적어보세요" aria-label="현재 상황 입력">',
              '<button type="button" class="ts100-btn ts100-btn-primary" data-action="wisdom-search">지혜 찾기</button>',
            '</div>',
            '<div class="ts100-wisdom-search-chips ts100-wisdom-chips-compact">',
              ...
              '<button type="button" class="ts100-search-chip" data-search-example="마음이 복잡해서 판단하기 어려워요">불안과 혼란</button>',
              '<button type="button" class="ts100-search-chip" data-search-example="새로운 도전을 앞두고 겁이 나요">용기와 도전</button>',
            '</div>',
            '<p class="ts100-search-status" data-bind="wisdom-search-status">현재 상황에서 생각해볼 세 가지 지혜를 찾습니다.</p>',
          ...
          '<div class="ts100-wisdom-mode-panel ts100-hidden" data-bind="wisdom-panel-idiom" role="tabpanel">',
            '<div class="ts100-idiom-finder-toolbar">',
              '<input type="search" class="ts100-idiom-finder-input" data-bind="wisdom-idiom-input" placeholder="예: 절처봉생, 絶處逢生" aria-label="사자성어 또는 한자 검색">',
              '<button type="button" class="ts100-btn ts100-btn-primary" data-action="wisdom-idiom-search">검색</button>',
            '</div>',
            '<p class="ts100-search-status" data-bind="wisdom-idiom-status">한글 제목이나 한자로 검색하세요.</p>',
            '<div class="ts100-idiom-finder-results" data-bind="wisdom-idiom-results" aria-live="polite"></div>',
          '</div>',

          '<div class="ts100-wisdom-mode-panel ts100-hidden" data-bind="wisdom-panel-life" role="tabpanel">',
            '<p class="ts100-wisdom-search-subtitle">지금 필요한 삶의 영역을 선택하세요.</p>',
            '<div class="ts100-life-category-grid" data-bind="wisdom-life-categories">',
              '<button type="button" data-life-category="자립과 생존">자립과 생존</button>',
              '<button type="button" data-life-category="용기와 도전">용기와 도전</button>',
              '<button type="button" data-life-category="인내와 끈기">인내와 끈기</button>',
              '<button type="button" data-life-category="실패와 회복">실패와 회복</button>',
              '<button type="button" data-life-category="선택과 결단">선택과 결단</button>',
              '<button type="button" data-life-category="관계와 공감">관계와 공감</button>',
              '<button type="button" data-life-category="마음과 수양">마음과 수양</button>',
              '<button type="button" data-life-category="배움과 성장">배움과 성장</button>',
              '<button type="button" data-life-category="세상과 처세">세상과 처세</button>',
              '<button type="button" data-life-category="변화와 인생">변화와 인생</button>',
            '</div>',
            '<p class="ts100-search-status" data-bind="wisdom-life-status">삶의 영역을 선택하면 해당 이야기 10편을 보여드립니다.</p>',
            '<div class="ts100-idiom-finder-results" data-bind="wisdom-life-results" aria-live="polite"></div>',
          '</div>',
        '</section>',
        ...
        '<section class="ts100-card ts100-experience" data-section="experience" id="ts100ExperienceSection">',
          ...
          '<div class="ts100-module-grid">',
            ...
            '<article class="ts100-module ts100-module-wide" data-module="meditation" id="ts100MeditationSection">',
              ...
              '<p class="ts100-module-desc">오늘의 네 글자를 떠올리며 음악과 함께 잠시 머물러보세요. 20곡 중 한 곡이 무작위로 선택됩니다.</p>',
              '<div class="ts100-meditation-box">',
                ...
                '<div class="ts100-reflection-track">',
                  ...
                  '<p class="ts100-reflection-track-title" data-bind="reflection-track-title">무작위 사색 음악</p>',
                  '<p class="ts100-reflection-track-subtitle" data-bind="reflection-track-subtitle">시작할 때 20곡 중 한 곡을 선택합니다.</p>',
                '</div>',
                '<div class="ts100-meditation-actions">',
                  ...
                  '<button type="button" class="ts100-btn" data-action="meditation-random">다른 음악</button>',
...
'<section class="ts100-card ts100-experience ts100-idiom-game-card" id="ts100IdiomGameSection" aria-label="사자성어 100선 게임">',
      ...
      '<button type="button" class="ts100-bottom-trigger" data-ts-bottom-open aria-haspopup="dialog" aria-controls="ts100BottomSheet">둘러보기</button>',
      '<div class="ts100-bottom-layer ts100-hidden" data-ts-bottom-layer>',
        '<button type="button" class="ts100-bottom-backdrop" data-ts-bottom-close aria-label="둘러보기 닫기"></button>',
        '<section class="ts100-bottom-sheet" id="ts100BottomSheet" role="dialog" aria-modal="true" aria-label="TimeStory 둘러보기">',
          '<div class="ts100-bottom-handle" aria-hidden="true"></div>',
          '<div class="ts100-bottom-head">',
            '<div><strong>TimeStory 둘러보기</strong><span>원하는 곳으로 바로 이동하세요.</span></div>',
            '<button type="button" class="ts100-bottom-close" data-ts-bottom-close aria-label="닫기">닫기</button>',
          '</div>',
          '<div class="ts100-bottom-grid">',
            '<button type="button" data-ts-bottom-target="#ts100StorySection"><strong>이야기</strong><span>이미지와 오디오</span></button>',
            '<button type="button" data-ts-bottom-target="#tsSeoStoryText"><strong>글로 읽기</strong><span>정적 전체 본문</span></button>',
            '<button type="button" data-ts-bottom-target="#ts100WisdomSearchSection"><strong>지혜찾기</strong><span>상황·사자성어·삶의 영역</span></button>',
            '<button type="button" data-ts-bottom-target="#ts100StoryLibrarySection"><strong>사자성어 100선</strong><span>10개 삶의 영역</span></button>',
            '<button type="button" data-ts-bottom-target="#ts100WisdomTreeSection"><strong>나의 기록</strong><span>지혜 서재</span></button>',
            '<button type="button" data-ts-bottom-target="#ts100MeditationSection"><strong>5분 사색</strong><span>무작위 20곡</span></button>',
          '</div>',
        '</section>',
      '</div>',
  ...
  TS100StoryExperience.prototype.cacheElements = function () {
    ...
    this.elements.wisdomPanelLife = qs(r, '[data-bind="wisdom-panel-life"]');
    this.elements.wisdomLifeStatus = qs(r, '[data-bind="wisdom-life-status"]');
    this.elements.wisdomLifeResults = qs(r, '[data-bind="wisdom-life-results"]');
  ...
  TS100StoryExperience.prototype.handleAction = function (action) {
    switch (action) {
      ...
      case "wisdom-mode-life": this.setWisdomFinderMode("life"); break;
...
TS100StoryExperience.prototype.renderStoryLibrary = function () {
  ...
  TS100StoryExperience.prototype.getAutomaticRelatedItems = function () {
    ...
    function add(item, label) {
      if (!item || item.slug === self.data.id || seen[item.slug] || picked.length >= 3) return;
      seen[item.slug] = true;
      picked.push(Object.assign({}, item, { relationLabel: label }));
    }

    var explicitSlugs = [];
    if (current && Array.isArray(current.relatedSlugs)) {
      explicitSlugs = explicitSlugs.concat(current.relatedSlugs);
    }
    (this.data.related || []).forEach(function (related) {
      ...
      if (match) explicitSlugs.push(match.slug);
    });
    explicitSlugs.forEach(function (slug) {
      add(items.find(function (item) { return item.slug === slug; }), "이야기를 이어서");
    });

    if (current && picked.length < 3) {
      items
        ...
        .forEach(function (item) { add(item, "같은 삶의 영역"); });
    }

    if (current && picked.length < 3) {
      var currentTerms = []
        .concat(current.tags || [])
        .concat([current.situation, current.message, current.emotionBefore, current.emotionAfter])
        .map(function (value) { return safeText(value).trim(); })
        .filter(Boolean);
      ...
      items
        ...
        .map(function (item) {
          var corpus = []
            .concat(item.tags || [])
            .concat([item.situation, item.message, item.emotionBefore, item.emotionAfter])
            .join(" ");
          var score = currentTerms.reduce(function (sum, term) {
            return sum + (term && corpus.indexOf(term) !== -1 ? 1 : 0);
          }, 0);
          return { item: item, score: score };
        })
        .sort(function (a, b) {
          if (a.score !== b.score) return b.score - a.score;
          var ap = a.item.url ? 1 : 0;
          var bp = b.item.url ? 1 : 0;
          if (ap !== bp) return bp - ap;
          return Number(a.item.number) - Number(b.item.number);
        })
        .forEach(function (row) { add(row.item, "다른 시선으로"); });
    }

    items.forEach(function (item) { add(item, "다른 시선으로"); });
  ...
  TS100StoryExperience.prototype.renderRelated = function () {
    ...
    relatedItems.forEach(function (item) {
      ...
      card.appendChild(createEl("span", "ts100-related-reason", item.relationLabel || "다른 시선으로"));
...
TS100StoryExperience.prototype.createStoryThumbnail = function (item) {
  ...
  TS100StoryExperience.prototype.setWisdomFinderMode = function (mode) {
    if (["situation", "idiom", "life"].indexOf(mode) === -1) mode = "situation";
    ...
    if (this.elements.wisdomPanelLife) {
      this.elements.wisdomPanelLife.classList.toggle("ts100-hidden", mode !== "life");
    }
    ...
    if (mode === "life") {
      var currentCategory = safeText(this.data.meta && this.data.meta.category).trim() || "자립과 생존";
      this.renderWisdomLifeResults(currentCategory);
    }
  };
  ...
  TS100StoryExperience.prototype.initWisdomFinderModes = function () {
    ...
    if (this.elements.wisdomIdiomInput) {
      this.elements.wisdomIdiomInput.addEventListener("input", function () {
        window.clearTimeout(self._wisdomIdiomTimer);
        self._wisdomIdiomTimer = window.setTimeout(function () {
          self.renderWisdomIdiomResults();
        }, 180);
      });
    ...
    qsa(this.root, "[data-life-category]").forEach(function (button) {
      button.addEventListener("click", function () {
        qsa(self.root, "[data-life-category]").forEach(function (item) {
          item.classList.toggle("is-active", item === button);
        });
        self.renderWisdomLifeResults(button.getAttribute("data-life-category") || "");
      });
    });
  };
  ...
  TS100StoryExperience.prototype.renderWisdomLifeResults = function (category) {
    var self = this;
    category = safeText(category).trim();
    if (!category) return;

    if (!this.getStoryLibraryItems().length) {
      if (this.elements.wisdomLifeStatus) this.elements.wisdomLifeStatus.textContent = "사자성어 목록을 불러오는 중입니다.";
      this.ensureStoryLibraryLoaded().then(function () {
        self.renderWisdomLifeResults(category);
      });
      return;
    }

    if (!this.elements.wisdomLifeResults || !this.elements.wisdomLifeStatus) return;
    var items = this.getStoryLibraryItems()
      .filter(function (item) { return item.category === category; })
      .slice(0, 10);

    this.elements.wisdomLifeResults.innerHTML = "";
    items.forEach(function (item) {
      ...
      var thumb = self.createStoryThumbnail(item);
      if (thumb) card.appendChild(thumb);

      var top = createEl("div", "ts100-library-card-top");
      top.appendChild(createEl("span", "ts100-library-number", String(item.number || "").padStart(3, "0")));
      top.appendChild(createEl("span", "ts100-library-state", isPublished ? "읽기" : "준비 중"));
      card.appendChild(top);
      card.appendChild(createEl("span", "ts100-library-hanja", item.hanja || ""));
      card.appendChild(createEl("strong", "ts100-library-title", item.title || ""));
      card.appendChild(createEl("p", "ts100-library-message", item.message || item.question || ""));
      self.elements.wisdomLifeResults.appendChild(card);
    });

    qsa(this.root, "[data-life-category]").forEach(function (button) {
      button.classList.toggle("is-active", button.getAttribute("data-life-category") === category);
    });

    this.elements.wisdomLifeStatus.textContent = category + " · " + items.length + "편";
  };
...
TS100StoryExperience.prototype.randomReflectionTrack = function (autoplay) {
  ...
  TS100StoryExperience.prototype.initBottomSheet = function () {
    var self = this;
    this.bottomLayer = qs(this.root, "[data-ts-bottom-layer]");
    this.bottomOpenButton = qs(this.root, "[data-ts-bottom-open]");
    if (!this.bottomLayer || !this.bottomOpenButton) return;

    this.bottomOpenButton.addEventListener("click", function () {
      self.openBottomSheet();
    });

    qsa(this.bottomLayer, "[data-ts-bottom-close]").forEach(function (button) {
      button.addEventListener("click", function () {
        self.closeBottomSheet();
      });
    });

    qsa(this.bottomLayer, "[data-ts-bottom-target]").forEach(function (button) {
      button.addEventListener("click", function () {
        var selector = button.getAttribute("data-ts-bottom-target");
    ...
    document.addEventListener("keydown", function (event) {
      if (event.key === "Escape" && self.bottomLayer && !self.bottomLayer.classList.contains("ts100-hidden")) {
        self.closeBottomSheet();
      }
    });
  };

  TS100StoryExperience.prototype.openBottomSheet = function () {
    if (!this.bottomLayer) return;
    this.bottomLayer.classList.remove("ts100-hidden");
    document.documentElement.classList.add("ts100-bottom-open");
    document.body.classList.add("ts100-bottom-open");
    this.bottomOpenButton.setAttribute("aria-expanded", "true");
    var closeButton = qs(this.bottomLayer, "[data-ts-bottom-close]");
    if (closeButton) window.setTimeout(function () { closeButton.focus(); }, 30);
  };

  TS100StoryExperience.prototype.closeBottomSheet = function () {
    if (!this.bottomLayer) return;
    this.bottomLayer.classList.add("ts100-hidden");
    document.documentElement.classList.remove("ts100-bottom-open");
    document.body.classList.remove("ts100-bottom-open");
    if (this.bottomOpenButton) {
      this.bottomOpenButton.setAttribute("aria-expanded", "false");
      this.bottomOpenButton.focus({ preventScroll: true });
    }
  };
